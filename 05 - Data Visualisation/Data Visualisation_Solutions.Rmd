...
\begin{LARGE}
 ...
 \vspace{0.2cm}
\end{LARGE}
These are the solutions to the exercises contained within the handout to “Data Visulaisation” which walks you through the basics of data visualisation in `R`using `ggplot2`. The plots presented here are using data from the `iris` data set supplied through the `datasets` package. 
