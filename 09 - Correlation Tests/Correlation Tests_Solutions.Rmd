...
ggplot(data = Data_df, aes(x = Latitude, y = Height)) +
  geom_point() + theme_bw() + stat_smooth(method = "lm") + 
...
cor.test(x = abs(Data_df$Latitude), y = Data_df$Weight, 
         use = "pairwise.complete.obs", method = "spearman")
ggplot(data = Data_df, aes(x = Latitude, y = Weight)) +
  geom_point() + theme_bw() + stat_smooth(method = "lm") + 
...
cor.test(x = abs(Data_df$Latitude), y = Data_df$Wing.Chord, 
         use = "pairwise.complete.obs", method = "spearman")
ggplot(data = Data_df, aes(x = Latitude, y = Wing.Chord)) +
  geom_point() + theme_bw() + stat_smooth(method = "lm") + 
...
cor.test(x = abs(Data_df$Latitude), y = Data_df$Number.of.Eggs, 
         use = "pairwise.complete.obs", method = "spearman")
ggplot(data = Data_df, aes(x = Latitude, y = Number.of.Eggs)) +
  geom_point() + theme_bw() + stat_smooth(method = "lm") + 
...
cor.test(x = abs(Data_df$Latitude), y = Data_df$Egg.Weight, 
         use = "pairwise.complete.obs", method = "spearman")
ggplot(data = Data_df, aes(x = Latitude, y = Egg.Weight)) +
  geom_point() + theme_bw() + stat_smooth(method = "lm") + 
...
```{r Spearman5, fig.width=15, fig.height = 7, tidy=FALSE}
